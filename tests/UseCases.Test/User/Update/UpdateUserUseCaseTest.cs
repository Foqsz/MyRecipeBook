...
public class UpdateUserUseCaseTest
{
    ...
    public async Task Success()
    {
        ...
        await act.ShouldNotThrowAsync(); //executar a função sem nenhum erro
    ...
    private static UpdateUserUseCase CreateUseCase(MyRecipeBook.Domain.Entities.User user, string? email = null)
    {
        ...
        var userUpdateRepository = new UserUpdateOnlyRepositoryBuilder().GetById(user).Build(); //chamada encadeadas
